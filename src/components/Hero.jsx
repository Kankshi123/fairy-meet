...
export default function Hero({ onBecomeSeeker, onBecomeCompanion }) {
    ...
    <section ref={containerRef} className="relative w-full pt-32 pb-24 lg:pt-48 lg:pb-32 px-6 md:px-12 bg-off-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-8 z-10">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start z-10">
          ...
          >
            <Magnetic>
              <button onClick={onBecomeSeeker} className="w-full sm:w-auto bg-rich-black text-pure-white font-sans text-xl sm:text-lg font-semibold px-10 py-6 sm:py-5 rounded-pill hover:bg-vibrant-pink transition-all hover:shadow-hover hover:-translate-y-1 text-center group">
                <span className="inline-block transition-transform group-hover:scale-105">Find Your Partner</span>
              </button>
            </Magnetic>
            <Magnetic>
              <button onClick={onBecomeCompanion} className="w-full sm:w-auto bg-transparent border-2 border-rich-black/20 text-rich-black font-sans text-xl sm:text-lg font-semibold px-10 py-6 sm:py-5 rounded-pill hover:border-rich-black transition-all hover:-translate-y-1 text-center flex items-center justify-center">
                Become a partner
              </button>
            </Magnetic>
          </motion.div>
